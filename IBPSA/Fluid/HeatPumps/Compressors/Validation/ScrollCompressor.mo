within IBPSA.Fluid.HeatPumps.Compressors.Validation;
...
equation
  ...
  annotation (    __Dymola_Commands(file= "modelica://IBPSA/Resources/Scripts/Dymola/Fluid/HeatPumps/Compressors/Validation/ScrollCompressor.mos"
        "Simulate and plot"),
    experiment(
