within Annex60.Fluid.Storage.BaseClasses.StratificationModel.Examples;
model InletStratification
extends Modelica.Icons.Example;
  replaceable
    Annex60.Fluid.Storage.BaseClasses.StratificationModel.PartialInletStratification
                                                                                               partialInletStratification(
  ...
  Annex60.Fluid.Sources.MassFlowSource_T boundary1(
    ...
    nPorts=1,
    use_T_in=true,
    T=328.15) annotation (Placement(transformation(extent={{64,-60},{44,-40}})));
  Annex60.Fluid.Sources.FixedBoundary bou1(redeclare package Medium =
        Medium, nPorts=1)
  ...
  Annex60.Fluid.Sources.FixedBoundary bou2(redeclare package Medium =
        Medium, nPorts=1)
  ...
  Annex60.Fluid.Sources.FixedBoundary bou3(redeclare package Medium =
        Medium, nPorts=1)
...
equation
  ...
  annotation (      __Dymola_Commands(file="modelica://Annex60/Resources/Scripts/Dymola/Fluid/Storage/BaseClasses/StratificationModel/Examples/InletStratification.mos"
        "Simulate and plot"));
