within Annex60.Fluid.Storage.BaseClasses.BuoyancyModels;
model Buoyancy1
protected
  extends Annex60.Fluid.Storage.BaseClasses.BuoyancyModels.PartialBuoyancy;
  ...
  parameter Real exp_nEle = 1.5 "Exponent for nEle";
initial equation
