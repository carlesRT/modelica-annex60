...
model StratifiedStorage "Model of a thermal fluid storage"
  ...
  replaceable Annex60.Fluid.Storage.BaseClasses.BuoyancyModels.PartialBuoyancy                        HeatBuoyancy(
    nEle=nEle) constrainedby
    Annex60.Fluid.Storage.BaseClasses.BuoyancyModels.PartialBuoyancy(
...
public
  ...
  Annex60.Fluid.MixingVolumes.MixingVolume vol_top(
    ...
    nPorts=3) annotation (Placement(transformation(extent={{10,-10},{-10,10}},
          origin={-12,40})));
  Annex60.Fluid.FixedResistances.LosslessPipe pip[nEle - 2](redeclare package
      Medium =         Medium, each m_flow_nominal=1.0)
